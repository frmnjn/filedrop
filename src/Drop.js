        ...
        <div className="w-1/3 mt-10 p-4 bg-white">
          <form className="border border-gray-500">
            <div className="p-4">
              ...
              <div className="mt-4">
                <button type="button" class="mt-1 p-2 border border-gray-400 rounded cursor-pointer bg-purple-600 text-white" onClick={this.onClickHandler}>Upload</button>

              </div>
            </div>
          </form>
          {console.log(this.state.loaded)}
          {this.state.loaded ? notify : ''}
          {/* <form className="border border-gray-500">
